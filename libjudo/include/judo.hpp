...
// 
// $Id: judo.hpp,v 1.1 2002/04/30 11:39:39 akuma Exp $
//============================================================================
...
namespace judo
{
    ...
    */
    ...
    public:
        ...
        */
        void setText(const char* text, size_t textsz, bool escaped = false)
	    { 
		if (escaped)
		{
		    unescape(text, textsz, _text); 
	   ...
	   @param escaped Is the text escaped?
        */
        void appendText(const char* text, size_t textsz, bool escaped = false)
	    { 
		if (escaped)
		{
    ...
    */
	...
	Element* addElement(const std::string& name, const std::string& cdata, 
			    bool escaped = false);
        CDATA*   addCDATA(const char* data, size_t datasz, bool escaped = false);	
    ...
    */
	...
	void push(const char* data, size_t datasz);
	void reset();
	...
	static void onCDATA(void* userdata, const char* cdata, size_t cdatasz);
