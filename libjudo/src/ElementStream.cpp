...
// 
// $Id: ElementStream.cpp,v 1.1 2002/04/30 11:39:39 akuma Exp $
//============================================================================
...
*/
void ElementStream::push(const char* data, size_t datasz)
{
...
void ElementStream::onCDATA(void* userdata, const char* cdata, size_t cdatasz)
{
    ElementStream* ts = (ElementStream*)userdata;
