...
// 
// $Id: Element.cpp,v 1.1 2002/04/30 11:39:39 akuma Exp $
//============================================================================
...
*/
CDATA* Element::addCDATA(const char* data, size_t datasz, bool escaped)
{
    CDATA *result;
...
Element::iterator Element::find(const string& name, Node::Type type)
{
    ...
    {
	if (((*result)->getType() == Node::ntElement) && 
	    ((*result)->getName() == name))
	    break;
    }
    return result;
