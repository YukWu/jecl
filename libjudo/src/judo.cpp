...
// 
// $Id: judo.cpp,v 1.1 2002/04/30 11:39:39 akuma Exp $
//============================================================================

#include "../include/judo.hpp"
using namespace std;

void judo::unescape(const char* src, size_t srcLen, string& dest, bool append)
{
    size_t i, j, len;
