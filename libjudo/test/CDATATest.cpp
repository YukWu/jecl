...
// 
// $Id: CDATATest.cpp,v 1.1 2002/04/30 11:39:43 akuma Exp $
//============================================================================
...
CPPUNIT_TEST_SUITE_REGISTRATION(CDATATest);
void CDATATest::construct()
{
    {
	CDATA c("Hello, world!", strlen("Hello, world!"));
	CPPUNIT_ASSERT(c._text == "Hello, world!");
    }

    {
	CDATA c("&amp; &apos; &quot; &lt; &gt;",strlen("&amp; &apos; &quot; &lt; &gt;"), true);
	cerr << c._text << endl;
	CPPUNIT_ASSERT(c._text == "& ' \" < >");
    }
...
void CDATATest::setText()
{
    ...
    CPPUNIT_ASSERT(c._text == "Yo buddy!");
}
...
void CDATATest::appendText()
{
    ...
    CPPUNIT_ASSERT(c._text == "Hello, world! Goodbye world!");
}
...
void CDATATest::getText()
{
    ...
    CPPUNIT_ASSERT(c.getText() == "Hello, world!");
}
